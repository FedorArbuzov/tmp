...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        test1 = Test.objects.create(name='Test 1', description='Description 1', attempts_number=3, assessment_method=True, shuffle=False, pub_date=timezone.now())
        test2 = Test.objects.create(name='Test 2', description='Description 2', attempts_number=2, assessment_method=False, shuffle=True, pub_date=timezone.now())
